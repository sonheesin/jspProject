...
if (searchWord != null) {//searchWord 값이 null 이 아니면 파라미터메모리에 값 추가
...
int blockPage =Integer.parseInt(application.getInitParameter("POSTS_PER_BLOCK"));//5
int totalPage =(int)Math.ceil((double)totalCount/pageSize); //전체 페이지 수
 ...
 if(pageTemp !=null && !pageTemp.equals(""))
	 pageNum = Integer.parseInt(pageTemp); //요청받은 페이지 수정
	...
	<table border="1" width="90%">
		...
		<tr align="center">
			...
			<td align="left"> <!-- 제목(+ 하이퍼링크) -->
			 <a href="View.jsp?num=<%=dto.getNum()%>"><%=dto.getTitle()%></a> <!-- get 방시긍로 번호가 넘어감 -->
			</td>
